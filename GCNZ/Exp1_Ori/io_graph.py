...
def make_corresp():
    seen_file = os.path.join(Material_DATA_DIR, 'KG-GAN', Material_EXP_NAME, 'seen.txt')  # nun:398
    unseen_file = os.path.join(Material_DATA_DIR, 'KG-GAN', Material_EXP_NAME, 'unseen.txt')  # num: 485
    seen_dict = {}
    unseen_dict = {}
    cnt = 0
    ...
    save_file = os.path.join(DATA_DIR, EXP_NAME, 'corresp.json')
