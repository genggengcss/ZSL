...
import sys
sys.path.append('../')
from LisGAN import config_args
from LisGAN import model
from LisGAN import classifier_cls
from LisGAN import classifier_pretrain
from LisGAN import util
...
for epoch in range(args.Epoch):
    ...
    syn_feature, syn_label = generate_syn_feature(netG, data.unseenclasses, data.semantic, args.SynNum)
    cls = classifier_cls.CLASSIFIER(syn_feature, util.map_label(syn_label, data.unseenclasses), data,
