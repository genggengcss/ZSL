...
def loadArgums():
    ...
    parser.add_argument('--SemEmbed', default='w2v', help='the type of class embedding to input')
    ...
    parser.add_argument('--ExpName', default='Exp10', help='the folder to store class file and class embedding file')
