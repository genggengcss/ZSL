...
if __name__ == '__main__':
    ...
    cls_vertices = os.path.join(DATA_DIR, Exp_NAME, 'graph', 'nodes_cls.json')
    att_vertices = os.path.join(DATA_DIR, Exp_NAME, 'graph', 'nodes_att.json')
    ...
    cls_save_file = os.path.join(DATA_DIR, Exp_NAME, 'graph', 'embed_cls.pkl')
    att_save_file = os.path.join(DATA_DIR, Exp_NAME, 'graph', 'embed_att.pkl')


    word_vectors = get_glove_dict('/Users/geng/Desktop/ZSL_DATA/ImageNet/Baseline/GCNZ/materials')
    get_vector = glove_google

    print('obtain semantic word embedding', cls_save_file)
    embed_text_file(cls_vertices, word_vectors, get_vector, cls_save_file)


    print('obtain semantic word embedding', att_save_file)
    embed_text_file(att_vertices, word_vectors, get_vector, att_save_file)