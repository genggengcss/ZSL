...
if __name__ == '__main__':
    ...
    # cls_seen_embed, cls_unseen_embed, cls_seen_corresp, cls_unseen_corresp = extract_embed('cls', '950.pkl')
    att_seen_embed, att_unseen_embed, att_seen_corresp, att_unseen_corresp= extract_embed('att', '2600.pkl')
    # save_file = 'n2v.mat'
