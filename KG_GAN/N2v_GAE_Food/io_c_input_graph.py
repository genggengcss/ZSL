...
def convert_graph(vertices, edges):
    ...
    node_embed_file = os.path.join(DATA_DIR, Exp_NAME, type_name, 'g_embed.mat')
...
if __name__ == '__main__':
    ...
    # seen, unseen, valid_class = load_class2()
    vertices, edges = prepare_graph(seen, unseen, tool_class)
    # vertices, edges = prepare_graph2(seen, unseen, valid_class)
