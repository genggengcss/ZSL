...
def extract_embed(seen_corresp, unseen_corresp):
    with open(os.path.join(DATA_DIR, Exp_NAME, 'embed', embed_file), 'rb') as f:
    ...
    save_file = os.path.join(DATA_DIR, Exp_NAME, 'embed', embed_file+'_su.pkl')
