...
def embed_text_file(vertices_f, word_vectors, get_vector, save_file, seen, unseen, seen_label_dict, unseen_label_dict):
    ...
    for each in missed_list:
        # print(each)
        if each in seen or each in unseen:
            print(each)
...
if __name__ == '__main__':
    ...
    embed_text_file(vertices_file, word_vectors, get_vector, save_file, seen, unseen, seen_label_dict, unseen_label_dict)