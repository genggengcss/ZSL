...
from N2v_GAE.utils import load_data_cls, mask_test_edges, preprocess_graph, get_roc_score
...
Exp_NAME = 'Exp15'
graphf = 'cls/graph.pkl'
input_embed = 'cls/g_embed.mat'
# input_embed = 'g_embed.pkl'
save_path = os.path.join(DATA_DIR, Exp_NAME, 'cls/embed')
