...
try
	...
	% Add -largeArrayDims on 64-bit machines of MATLAB
		...
		mex COMPELAGS='$CFLAGS -fopenmp' CXXFLAGS='$CXXFLAGS -fopenmp' -I.. -largeArrayDims -lgomp train.c linear_model_matlab.c ../linear.cpp ../tron.cpp ../blas/daxpy.c ../blas/ddot.c ../blas/dnrm2.c ../blas/dscal.c
		mex COMPELAGS='$CFLAGS -fopenmp' CXXFLAGS='$CXXFLAGS -fopenmp' -I.. -largeArrayDims -lgomp predict.c linear_model_matlab.c ../linear.cpp ../tron.cpp ../blas/daxpy.c ../blas/ddot.c ../blas/dnrm2.c ../blas/dscal.c
	end
catch err
